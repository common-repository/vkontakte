 ...
 */
$shortcode  = Vkontakte_Frontend_Shortcode_Poll::get_code();
$attributes = Vkontakte_Frontend_Shortcode_Poll::get_attributes();
?>
...
<p>
	<?php _e( 'A poll can be added as WP widget (depends on the theme).', 'vkontakte' ); ?>
	<?php echo sprintf( __( 'Also you can use a shortcode %s to add the poll in the content.', 'vkontakte' ), sprintf( '<b>[%s]</b>', $shortcode ) ); ?>
</p>
...
<code>
    [<?php echo $shortcode; ?> id='poll_id_value' element_id='custom_element_id' width='0' page_url='https://vk.com']
</code>
