...
<p>
	<?php _e( 'There are no WP widgets or shortcodes for Share button at the moment.', 'vkontakte' ); ?>
	<?php echo sprintf( __( 'You can only <a href="%s">configure</a> a rendering of Share button on single post view page.', 'vkontakte' ), $settings_url ); ?>
</p>
